		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Free Style Fiori App",
									"targetURL": "#comkapilfreestylefioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkapilfreestylefioriapp-display": {
								"semanticObject": "comkapilfreestylefioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kapil.freestylefioriapp",
									"url": sap.ui.require.toUrl("com/kapil/freestylefioriapp")
								}
							}
						}
					}
